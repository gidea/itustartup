...
import Logo from '../images/itustartup-logo.svg';
          ...
          {({ open }) => (
            <>
                ...
                <div className="flex justify-start lg:w-0 lg:flex-1">
                  ...
                  <a href="#">
                    ...
                    <img
                      ...
                      src={Logo}
                      alt="ITU Startup Logo"
                    />
                  </a>
                </div>
                <div className="-mr-2 -my-2 md:hidden">
                  <Popover.Button className="bg-gray-100 rounded-md p-2 inline-flex items-center justify-center text-gray-700 hover:text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
                      ...
                      <>
                        <Popover.Button
                          className={classNames(
                            ...
                            'group bg-gray-200 rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
                          )}
                        >
              ...
              >
                ...
                >
                  <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-gray-100 divide-y-2 divide-gray-50">
                    <div className="pt-5 pb-6 px-5">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="-mr-2">
                          <Popover.Button className="bg-gray-300 rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
